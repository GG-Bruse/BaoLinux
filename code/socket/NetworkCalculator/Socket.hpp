...
public://服务端专用
    void Bind(int listenSocketFd, uint16_t serverPort, std::string serverIp = "0.0.0.0") {
    ...
    void Listen(int listenSocketFd) {
    ...
    int Accept(int listenSocketFd, std::string* clientIp, uint16_t* clientPort) {
